...
export const PlaceDetailModal: React.FC<PlaceDetailModalProps> = ({
  ...
  return (
    ...
    >
      ...
      <div className="p-4 sm:p-5 overflow-y-auto flex-1 space-y-4 text-[#1F2430] dark:text-slate-100 bg-white dark:bg-slate-900">
        {activeTab === 'info' && (
          <>
            {/* Quick Info Grid */}
            <div className="grid grid-cols-2 sm:grid-cols-3 gap-2.5 text-xs">
              <div className="p-2.5 rounded-2xl bg-[#F7F3EC] dark:bg-slate-800/80 border border-[#DDD5C5] dark:border-slate-700">
              ...
              <div className="p-2.5 rounded-2xl bg-[#F7F3EC] dark:bg-slate-800/80 border border-[#DDD5C5] dark:border-slate-700 col-span-2 sm:col-span-1">
            ...
            <div>
              ...
              <div className="grid grid-cols-2 gap-2 text-xs">
                <div className={`p-2.5 rounded-xl border flex items-center gap-2 ${
                  place.features.ladiesSection ? 'bg-emerald-50/50 dark:bg-emerald-950/30 border-emerald-200 dark:border-emerald-800 text-emerald-900 dark:text-emerald-300' : 'bg-gray-50 dark:bg-slate-800/40 border-gray-200 dark:border-slate-700 text-gray-400 dark:text-slate-500'
                }`}>
                ...
                <div className={`p-2.5 rounded-xl border flex items-center gap-2 ${
                  place.features.wheelchairAccess ? 'bg-emerald-50/50 dark:bg-emerald-950/30 border-emerald-200 dark:border-emerald-800 text-emerald-900 dark:text-emerald-300' : 'bg-gray-50 dark:bg-slate-800/40 border-gray-200 dark:border-slate-700 text-gray-400 dark:text-slate-500'
                }`}>
                ...
                <div className={`p-2.5 rounded-xl border flex items-center gap-2 ${
                  place.features.quranClasses ? 'bg-emerald-50/50 dark:bg-emerald-950/30 border-emerald-200 dark:border-emerald-800 text-emerald-900 dark:text-emerald-300' : 'bg-gray-50 dark:bg-slate-800/40 border-gray-200 dark:border-slate-700 text-gray-400 dark:text-slate-500'
                }`}>
                ...
                <div className={`p-2.5 rounded-xl border flex items-center gap-2 ${
                  place.features.liveBroadcast ? 'bg-emerald-50/50 dark:bg-emerald-950/30 border-emerald-200 dark:border-emerald-800 text-emerald-900 dark:text-emerald-300' : 'bg-gray-50 dark:bg-slate-800/40 border-gray-200 dark:border-slate-700 text-gray-400 dark:text-slate-500'
                }`}>
                ...
                <div className={`p-2.5 rounded-xl border flex items-center gap-2 ${
                  place.features.parking ? 'bg-emerald-50/50 dark:bg-emerald-950/30 border-emerald-200 dark:border-emerald-800 text-emerald-900 dark:text-emerald-300' : 'bg-gray-50 dark:bg-slate-800/40 border-gray-200 dark:border-slate-700 text-gray-400 dark:text-slate-500'
                }`}>
            ...
            {/* Address & Phone */}
            <div className="p-3 rounded-2xl bg-[#F7F3EC] dark:bg-slate-800/80 border border-[#DDD5C5] dark:border-slate-700 space-y-1.5 text-xs">
              ...
              {place.phone && (
                <div className="flex items-center gap-2 text-[#52525B] dark:text-slate-300">
                  ...
                  <a href={`tel:${place.phone}`} className="hover:underline font-bold text-[#0E7C86] dark:text-teal-400">
                    {toPersianDigits(place.phone)}
                  </a>
                </div>
              )}
            </div>
          ...
          <div className="space-y-3">
            {placeEvents.length === 0 ? (
              ...
              placeEvents.map((event) => (
                <div
                  key={event.id}
                  className="p-3.5 rounded-2xl bg-[#F7F3EC] dark:bg-slate-800/80 border border-[#DDD5C5] dark:border-slate-700 space-y-2 text-xs"
                >
                  <div className="flex items-center justify-between">
                    <span className="font-bold text-[#B4552D] bg-white dark:bg-slate-900 px-2 py-0.5 rounded-md border border-[#DDD5C5] dark:border-slate-700">
                      {event.timeBadge}
                    </span>
                    <button
      ...
      <div className="p-3.5 bg-white dark:bg-slate-900 border-t border-[#E0D8C8] dark:border-slate-800 flex items-center gap-2 shrink-0">
        <a
          href={routing.neshan}
          target="_blank"
          rel="noopener noreferrer"
          className="flex-1 flex items-center justify-center gap-1.5 bg-[#0E7C86] hover:bg-[#0a5d65] dark:bg-teal-600 dark:hover:bg-teal-700 text-white py-2.5 px-3 rounded-2xl text-xs font-bold shadow-xs transition-all"
        >
        ...
        <a
          ...
          target="_blank"
          rel="noopener noreferrer"
          className="flex-1 flex items-center justify-center gap-1.5 bg-[#B4552D] hover:bg-[#964220] dark:bg-amber-600 dark:hover:bg-amber-700 text-white py-2.5 px-3 rounded-2xl text-xs font-bold shadow-xs transition-all"
        >
        ...
        <a
          ...
          target="_blank"
          rel="noopener noreferrer"
          className="p-2.5 rounded-2xl bg-[#F7F3EC] dark:bg-slate-800 border border-[#DDD5C5] dark:border-slate-700 text-[#1F2430] dark:text-slate-100 hover:bg-stone-50 text-xs font-bold"
          title="Google Maps"
        >
          گوگل‌مپ
        </a>
